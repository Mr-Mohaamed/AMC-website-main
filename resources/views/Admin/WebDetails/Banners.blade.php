                                ...
                                <div class="row" style="justify-content:space-evenly">
                                    ...
                                    <div class="col-lg-6">
                                        <div class=" form-Roles mb-3">
                                            ...
                                            <input class="form-control" name="img2" accept="image/*" type="file" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-body p-0">
                            ...
                            <div class="p-4">
                                ...
                                <div class="row align-items-end" style="justify-content:space-evenly">
                                    ...
                                    <div class="col-lg-6 form-Roles mb-3">
                                        <div class="d-flex justify-content-center mt-3">
                                            <img src="" class="w-70 " style="width: 300px" id="img_edit2"
                                                alt="">
                                        </div>
                                        <label class="form-label" for="customFile">
                                            {{ __('validation.choose_img') }}
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, item) {
                            ...
                            var country_img2 = item.img2 ? item.img2 :
                                '{{ asset('newAdmin/assets/img/user.png') }}';
                            ...
                            $('.country_table').append('<tr>\
                                ...
                                item.id + '"> {{ __('validation.update') }} </button>\
